...
const Canvas = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 relative overflow-hidden">
      {/* Dotted Grid Background - Full Screen */}
      ...
      <div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-20">
        <div className="w-16 bg-zinc-800/90 backdrop-blur-md border border-zinc-700/50 rounded-2xl flex flex-col items-center py-4 shadow-2xl">
          {/* Top Tools */}
      ...
      <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-20">
        <div className="bg-zinc-800/90 backdrop-blur-md border border-zinc-700/50 rounded-2xl px-6 py-3 shadow-2xl">
          <div className="flex items-center justify-between min-w-[600px]">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 bg-zinc-700/50 rounded-lg px-3 py-1">
